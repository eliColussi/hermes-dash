...
# Per-client pack. Generated by the AI Staffroom lead-magnet pipeline into
# <repo>/client/: agents.seed.yaml (first-boot agents), skills/<client>/<sop>/SKILL.md
# (SOPs + playbooks the agents can read), CLIENT.md (the brief). Absent on the
# base template; every path below is optional at runtime.
REPO_ROOT = Path(__file__).resolve().parent.parent.parent
CLIENT_DIR = REPO_ROOT / "client"
CLIENT_SKILLS_DIR = CLIENT_DIR / "skills"
CLIENT_AGENTS_SEED = CLIENT_DIR / "agents.seed.yaml"
